...
const actionData: {
...
}[] = [
  {
    ...
    desc: [
      ...
      "Share anti-hate materials with your team or organization.",
      "If you experienced discrimination or bias, tell your non-Asian friends and colleagues about that. Share both the facts and your feelings.",
  ...
  },
  {
    ...
    desc: [
      ...
      "Help the police to capture suspects.",
      "Help the effort to bring justice to victims.",
  ...
  },
  {
    ...
    desc: [
      "Communicate: as a global majority friend about their experience living in the US.",
      "Empathize: try to relate to others, share the challenges the AAPI community is facing.",
