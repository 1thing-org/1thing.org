    ...
    return (
      <div className={styles.ActionPageBody}>
        ...
        <Container id="culture">
          ...
          <ul>
            <li>
              Ask a minority friend about challenges they experienced while
              growing up and living in the US. Try to relate to them and perhaps
              share your challenges with what the AAPI community is facing.
            </li>
            <li>
