...
const SocialMediaShareSummary =
  "We all can make small contributions to improve racial equality. Share what you did and inspire more to join the force. Together we can create bigger changes."
const SocialMediaShareSummaryShort =
  "We all can make small contributions to improve racial equality. Share what you did and inspire more to join the force. Together we can create bigger changes."
const SocialMediaSharing = ({ size, bgStyle, iconFillColor }) => {
  return (
    <>
      <TwitterShareButton title={SocialMediaShareSummaryShort} url={"https://www.1thing.org/"} hashtags={["1thing"]}>
      ...
      &nbsp;
      <FacebookShareButton url={"https://www.1thing.org/"} quote={SocialMediaShareSummary} hashtag={"1thing"}>
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => window.open("https://www.linkedin.com/company/1-thing-org")}
      >
        <LinkedinIcon round size={size} bgStyle={bgStyle} iconFillColor={iconFillColor} />
      </button>
      &nbsp;
      <button
        className={"button-no-background"}
        onClick={() => window.open("https://www.facebook.com/One-Thing-Org-103418918935944")}
      >
        <FacebookIcon round size={size} bgStyle={bgStyle} iconFillColor={iconFillColor} />
      </button>
    </>
