  ...
  return (
    <>
      <button
        ...
        onClick={() => window.open("https://twitter.com/1Thing_Org")}
      >
        <TwitterIcon
          round
          size={size}
      ...
      <button
        className={"button-no-background"}
        onClick={() =>
          window.open("https://www.linkedin.com/company/1-thing-org")
        }
      >
        <LinkedinIcon
          round
      ...
      <button
        className={"button-no-background"}
        onClick={() =>
          window.open("https://www.facebook.com/One-Thing-Org-103418918935944")
        }
      >
        <FacebookIcon
          round
