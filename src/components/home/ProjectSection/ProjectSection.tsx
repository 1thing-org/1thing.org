...
const projectData: {name: string, desc: string, imageUrl: string, projectUrl: string}[] = [
    {
    ...
    render(){
        return(
            <div id="project-section">
                <Project name={projectData[0].name} desc={projectData[0].desc} imageUrl={projectData[0].imageUrl} projectUrl={projectData[0].projectUrl}/>
                <div id="bottom">
                    <Project name={projectData[1].name} desc={projectData[1].desc} imageUrl={projectData[1].imageUrl} projectUrl={projectData[1].projectUrl}/>
                    <div id="middle"></div>
                    <Project name={projectData[2].name} desc={projectData[2].desc} imageUrl={projectData[2].imageUrl} projectUrl={projectData[2].projectUrl}/>
                </div>
            </div>
        )
    }
