      ...
      {dimensions.width < 576 ? (
        <Container fluid className="details1" id="actions">
          ...
          <Container>
            <p className="p2">
              <li>
                Tell a friend or colleague that you are concerned for your safety out in the streets nowadays because of
          ...
          <Container>
            <p className="p2">
              ...
              <li>
                Tell a hate incident/crime victim that you want to listen to their feelings. Tell a hate crime victim
          ...
          <Container>
            <p className="p2">
              <li>
                Create: paint, draw, or digitally make a piece of art that reflects your attitude towards asian-hate,
                prejudice, and bias.
              </li>
        ...
        <Container fluid className="details" id="actions">
          <Row className="box2 align-items-center">
            ...
            <Col lg={8} md={8} sm={8}>
              ...
              <p className="p2">
                <li>
                  Tell a friend or colleague that you are concerned for your safety out in the streets nowadays because
                  of Anti-Asian hate crime incidents.
                </li>
                <li>Talk about this issue with coworkers.</li>
                <li>In a team meeting, share what you are doing to fight hate.</li>
              </p>
          ...
          <Row className="box2 align-items-center">
            ...
            <Col lg={8} md={8} sm={8}>
              ...
              <p className="link2">
                <Link to="/actionpage#expertise" className="vm2" target="_blank">
                  View More &rarr;
                </Link>
              </p>
            </Col>
