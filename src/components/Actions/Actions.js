...
import { Button, Row, Col, Container, NavLink} from "reactstrap";
  ...
  return () => { window.removeEventListener('resize', handleResize) }
      ...
      return (
        <div className="box">
          <Container className="title">
            ...
            <Row>
              ...
              <i className="fa fa-angle-double-down" ></i></NavLink>
              </Col>
            </Row>
          </Container>
        ...
        <Container className="details1" id="actions">
          ...
          <img src={Awareness} alt="AWARENESSawareness"/></Row>
          <Col xs={12}>
            ...
            <p className="link2"><Link to="/actionpage#awareness" className="vm2">View More &rarr;</Link></p>
          </Col>
          ...
          <Col xs={12}>
            ...
            <p className="link2"><a className="vm2"><Link to="/actionpage#support">View More &rarr;</Link></a></p>
           </Col>
           ...
           <img src={Expertise} alt="USE EXPERTISE" /></Row>
            <Col xs={12}>
              ...
              <p className="link2"><a className="vm2"><Link to="/actionpage#expertise">View More &rarr;</Link></a></p>
             </Col>
