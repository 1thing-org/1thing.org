                ...
                <div className="form-inner-cont">
                    <form action="https://1thing.us20.list-manage.com/subscribe/post?u=21d473c726961a9ff53d21a35&id=81aac402d9" method="post" className="signin-form">
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',}}>
                            <img src={logo} alt="Logo" style={{ width: '37px', height: '23.5px'}} />
                            <h4 style={{ textAlign: 'center', marginBottom: '0' }}>Contact Us</h4>
                        </div>
                        <div className="form-input">
                            <label className='smallTitle' htmlFor="FNAME">Name</label>
                        ...
                        <div className="form-input">
                            <label className='smallTitle' htmlFor="EMAIL">Email</label>
